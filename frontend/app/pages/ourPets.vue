                ...
                <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 mx-9">
                    ...
                    >
                        ...
                        <div class="flex flex-col md:flex-row gap-2 md:gap-3 p-6 pt-0">
                            <button class="btn text-xl font-normal flex-1" @click.prevent.stop>
                                ХОЧУ ЗАБРАТЬ
                            </button>
                            <button 
...
watch(() => isCustodyModalOpen.value, (newVal) => {
    if (newVal) {
        disableBodyScroll()
    } else {
        enableBodyScroll()
